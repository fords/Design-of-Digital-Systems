#!/bin/ksh
# This script was generated Fri Oct 31 22:55:36 2014 by:
#
...
#	/home/zxw6805/ee620/zxw_inv.xcn -assura_run_dir /home/zxw6805/ee620/ \
#	-assura_run_name zxw_inv -rcxdir /home/zxw6805/ee620/zxw_inv -type \
...
#	/home/zxw6805/ee620/zxw_inv.sp -net_name_space layout -minR 0.001 \
...
#	/home/zxw6805/ee620/zxw_inv.gnx,/home/zxw6805/ee620/zxw_inv.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##NETS_FILE=/dev/null
##OUTPUT=/home/zxw6805/ee620/zxw_inv.sp
...
##RC_FREQUENCY=
##RCXDIR=/home/zxw6805/ee620/zxw_inv
##RCXFS_HIGH=N
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/zxw6805/ee620/zxw_inv.gnx,/home/zxw6805/ee620/zxw_inv.gdx
##XY_COORDINATES=
##=======================================================
...
vdbToRcx /home/zxw6805/ee620 zxw_inv -unit microns -- -V1 -H satfile -r \
	/home/zxw6805/ee620/zxw_inv.xcn -xgl
...
advgen -FD '@' -V -g0 -li -f -n -o CDL -h ${HIERARCHY_DELIMITER} -TL \
	L1T0,L2T0,L3T0,L4T0 -subc '#' -nxref /home/zxw6805/ee620/zxw_inv.gnx \
	-dxref /home/zxw6805/ee620/zxw_inv.gdx -sc caps2dversion -m capfile \
